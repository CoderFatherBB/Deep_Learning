<div align="center">
  <h1 align="center">Sign Language Detection Yolov6</h1>
  <p align="center">
...
Welcome to the **Sign Language Detection Yolov6** project! This directory contains the specific source code, resources, and implementation details for this project.
...
1. Ensure you are in the project directory:
   ```bash
   cd "Sign_Language_Detection_YOLOv6"
   ```
